...
const Ephesians: DeepPartial<Book> = {
  name: "Ephesians",
  chapters: [
    {
      number: 1,
    ...
    },
    {
      ...
      verses: [
        ...
        { number: 5, text: "One Lord, one faith, one baptism," },
        {
          number: 6,
        ...
        { number: 20, text: "But ye have not so learned Christ;" },
        {
          number: 21,
        ...
        { number: 23, text: "And be renewed in the spirit of your mind;" },
        {
          number: 24,
        ...
        { number: 27, text: "Neither give place to the devil." },
        {
          number: 28,
    ...
    },
    {
      ...
      verses: [
        ...
        { number: 7, text: "Be not ye therefore partakers with them." },
        {
          number: 8,
        ...
        { number: 10, text: "Proving what is acceptable unto the Lord." },
        {
          number: 11,
