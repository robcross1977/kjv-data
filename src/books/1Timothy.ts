...
const OneTimothy: DeepPartial<Book> = {
  name: "1 Timothy",
  chapters: [
    {
      number: 1,
    ...
    },
    {
      ...
      verses: [
        ...
        { number: 13, text: "For Adam was first formed, then Eve." },
        {
          number: 14,
    ...
    },
    {
      ...
      verses: [
        ...
        { number: 11, text: "These things command and teach." },
        {
          number: 12,
    ...
    },
    {
      ...
      verses: [
        ...
        { number: 3, text: "Honour widows that are widows indeed." },
        {
          number: 4,
