...
const TwoTimothy: DeepPartial<Book> = {
  name: "2 Timothy",
  chapters: [
    {
      number: 1,
    ...
    },
    {
      ...
      verses: [
        ...
        { number: 9, text: "Do thy diligence to come shortly unto me:" },
        {
          number: 10,
        ...
        { number: 12, text: "And Tychicus have I sent to Ephesus." },
        {
          number: 13,
